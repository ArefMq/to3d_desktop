    ...
    QWidget(parent)
{
  ...
  _scene->setPickpointEnabled(true);
  _scene->setPointSize(2);
  _camera->setFrontCPDistance(0); // negative
...
//  xSlider->setGeometry(420, 10, 150, 30);
//  ySlider->setGeometry(420, 50, 150, 30);
//  zSlider->setGeometry(420, 90, 150, 30);
